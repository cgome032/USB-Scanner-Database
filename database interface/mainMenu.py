...
class MainMenu:
    ...
    def __init__(self,master):
        ...
        self.userAttempt = Button(self.loginFrame, width=self.userWidth, text="Login", relief=GROOVE, command=lambda: self.employee_login(self.userId.get(), self.userPw.get()))
        self.master.bind('<Return>', lambda x: self.employee_login(self.userId.get(), self.userPw.get()))
